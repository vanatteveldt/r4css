...
always very helpful... It will also sometimes fail to recognize a submission as correct if it's different from it's own solution. So, if you're sure you're getting the right results but R won't give you full grades for it, just congratulate yourself for being original!
:::
...
With apologies to the americans, we color right wing parties as blue (and call them liberal!),
and left wing parties as red:

```{webr}
#| exercise: beautiful_bar
party_colors <- c(
  "PvdA/GL"="#DA2128", "SP"="#ED1C24", "NSC"="#1E5AA8", "VVD"="#0A2074", "PVV"="#6F4E37",
